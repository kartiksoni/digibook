        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">Digibooks</h3>
                        <!--<div class="heading-line">
                            <span class="long-line"></span>
                        </div>-->
                        <p class="heading-text" style="color:#3c3c3c;">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus, nascetur ridiculus mus.
                        </p>
                    </div>
                    ...
                    <div class="socials">
                        ...
                        <a href="#" class="social__item">
                            <img src="svg/youtube.svg" alt="google">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="services">
                       ...
                       <ul class="list list--primary">
                            <li>
                                ...
                                <a href="#">ePharma&trade;</a>
                            </li>

                            <li>
                                <i class="fa fa-caret-right" aria-hidden="true"></i>
                                <a href="#">i-HIS&trade;</a>
                            </li>
                        </ul>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">0285 - 2656778 / 9 &nbsp; +91 98252 16030</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">info@digibooks.com</a>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <p style="color:#3c3c3c;">Opp. Mahalaxmi Temple,Danapith, Junagadh 362001.Gujarat. (India)<br></p>
                            <p class="sub-title"></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2018 <a href="index" class="sub-footer__link">Digibooks,</a>
                        Designed &amp; Developed by <a href="http://www.sanskartechnolab.com/" target="_blank">Sanskartechnolab.com</a>                    </span>
