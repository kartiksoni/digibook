...
<?php 
    if(isset($_GET['id']) && $_GET['id'] != ''){
        ...
        $query = "SELECT tb.id, tb.pharmacy_id, tb.invoice_no, tb.invoice_date, tb.bill_type, tb.total_return_amount, tb.alltotalamount, tb.couriercharge, tb.couriercharge_val, tb.totaligst, tb.totalcgst, tb.totalsgst, tb.totaltaxgst, tb.discount_type, tb.discount_per, tb.discount_rs, tb.cr_db_type, tb.cr_db_val, tb.final_amount, lg.name as customer_name, lg.addressline1, lg.addressline2, lg.addressline3, lg.gstno,st.name as customer_state, ct.name as customer_city,dp.name as doctor_name FROM tax_billing tb INNER JOIN ledger_master lg ON tb.customer_id = lg.id LEFT JOIN own_states st ON lg.state = st.id LEFT JOIN own_cities ct ON lg.city = ct.id LEFT JOIN doctor_profile dp ON tb.doctor = dp.id  WHERE tb.pharmacy_id ='".$pharmacy_id."' AND tb.id='".$_GET['id']."'";
...
<body>
    <div class="invoice-box">
        ...
        <table cellpadding="0" border="1"  cellspacing="0">
            ...
            <tr class="" style="line-height:12px;">
            	<td style="height:10px;font-size:8px;text-align:center;font-weight:bold;">Details of Receiver | Billed to:</td>
            	<td style="height:10px;font-size:8px;text-align:center;font-weight:bold;">Details of Consignee | Shipped to:</td>                
            </tr> -->
            ...
            <!-- <tr class="" style="line-height:12px;">
                <td  style="vertical-align:top;">
                    <table  cellpadding="0" cellspacing="0" border="0" style="line-height:10px;font-size:9px;">
                        <tr>
                            <td style="vertical-align:top">
                                <b style="width:100px;float:left; ">Name </b>:<span style="font-size:10px"> Shyam Enterprises</span>
                             </td>
                        </tr>
						<tr>     
                            <td>
                            		<b style="width:100px;float:left;">Address </b> 
                                    <div style="width:150px;float:left;">: Address of the Customer</div>
                            </td>
                        </tr>
                        <tr>     
                            <td>
                            		<b style="width:100px;float:left;">GSTIN </b> 
                                    <div style="width:150px;float:left;">: 24ABCCA123421ZK</div>
                            </td>
                        </tr>
						<tr>     
                            <td>
                            		<b style="width:100px;float:left;">State </b> 
                                    <div style="width:150px;float:left;">: Gujarat</div>
                            </td>
