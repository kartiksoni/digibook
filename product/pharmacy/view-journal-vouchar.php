...
<head>
  ...
  <title>DigiBooks | View Journal Voucher</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    <a href="journal-vouchar.php" class="btn btn-success p-2 pull-right" title="Add Vouchar"><i class="mdi mdi-plus-circle-outline"></i>Add Vouchar</a>
                    <h4 class="card-title">View Journal Vouchar</h4><hr class="alert-dark">
                    <div class="col mt-3">
                       <div class="row">
                            <div class="col-12">
