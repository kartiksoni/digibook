                              ...
                              <select id="deposit_bank" name="deposit_bank_cheque" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-bankcheque"> 
                                ...
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($vendordata['deposit_bank_cheque']) && $vendordata['deposit_bank_cheque'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                              </select>
                            ...
                            <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_dd" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-bankdd"> 
                               <option value="">Select Bank</option>
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($vendordata['deposit_bank_dd']) && $vendordata['deposit_bank_dd'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group row div_net_banking" <?php if(isset($_REQUEST['id']) && $vendordata['payment_mode'] == "net_banking"){ } else{ ?> style="display: none;" <?php } ?>>
                          ...
                          <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_net_banking" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-banknetbanking"> 
                                ...
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($vendordata['deposit_bank_net_banking']) && $vendordata['deposit_bank_net_banking'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                          ...
                          <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_credit_debit_card" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-bankcard"> 
                               <option value="">Select Bank</option>
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($vendordata['deposit_bank_credit_debit_card']) && $vendordata['deposit_bank_credit_debit_card'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                              </select>
