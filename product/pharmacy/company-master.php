...
<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    if(isset($_GET['id']) && $_GET['id'] != ''){
      ...
      $query = "INSERT company_master SET ";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-4">
                          <label for="exampleInputName1">Company Code <span class="text-danger">*</span></label>
                  ...
                  <div class="col mt-3">
                    <h4 class="card-title">View Company Master</h4>
                    <hr class="alert-dark">
                       <div class="row">
                            <div class="col-12">
                              <table id="order-listing1" class="table">
                                ...
                                <tbody>
                                  <!-- Row Starts -->   
                                  <?php
                                    $getAllCompanyQuery = "SELECT * FROM `company_master` ORDER BY id DESC";
