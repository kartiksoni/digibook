                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" autocomplete="off">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-2">
                        <label for="to">Transport Name<span class="text-danger">*</span></label>
                        <select class="js-example-basic-single" data-parsley-errors-container="#error-vendor" required="" style="width:100%" name="transport" id="vendor"> 
