...
<?php 
  ...
  if(isset($_POST['search'])){
    ...
    $searchdata = customerLedger($customer, $from, $to);
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Digibooks | Customer Ledger</title>
  <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Customer Ledger</h4><hr class="alert-dark">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-3">
                          ...
                          <select class="js-example-basic-single" style="width:100%" name="customer" id="customer" data-parsley-errors-container="#error-customer" required> 
                              ...
                              <?php 
                                $getAllCustomerQ = "SELECT id, name FROM ledger_master WHERE status=1 AND group_id=10 AND pharmacy_id = '".$pharmacy_id."' AND is_cash = 0 ORDER BY name";
                        ...
                        <div class="col-12 col-md-5 col-sm-12">
                          ...
                          <?php if(isset($searchdata)){ ?>
                            <a href="customer-ledger-print.php?id=<?php echo (isset($_POST['customer'])) ? $_POST['customer'] : ''; ?>&from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                          <?php } ?>
