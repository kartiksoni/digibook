                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="purchase-top-btns">
                            <?php if(isset($user_sub_module) && in_array("Cash Management", $user_sub_module)){ ?>
                                <a href="accounting-cash-management.php" class="btn btn-dark active">Cash Management</a>
                            <?php } if(isset($user_sub_module) && in_array("Customer Receipt", $user_sub_module)){ ?>
                                <a href="accounting-customer-receipt.php" class="btn btn-dark btn-fw">Customer Receipt</a>
                            <?php } if(isset($user_sub_module) && in_array("Cheque", $user_sub_module)){ ?>
                                <a href="accounting-cheque.php" class="btn btn-dark  btn-fw">Cheque</a>
                            <?php } if(isset($user_sub_module) && in_array("Vendor Payment", $user_sub_module)){ ?>
                                <a href="accounting-vendor-payments.php" class="btn btn-dark  btn-fw">Vendor Payment</a>
                            <?php } if(isset($user_sub_module) && in_array("Financial Year Settings", $user_sub_module)){ ?>
                                <a href="financial-year.php" class="btn btn-dark  btn-fw">Financial Year Settings</a>
                            <?php } if(isset($user_sub_module) && in_array("Credit Note / Purchase Note", $user_sub_module)){ ?>
                                <a href="purchase-return.php" class="btn btn-dark  btn-fw">Credit Note / Purchase Note</a>
                            <?php } if(isset($user_sub_module) && in_array("Journal Vouchar", $user_sub_module)){ ?>
                  ...
                  <form method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <table id="entryTable" class="table">
                     ...
                     <tbody>
                      <tr>
                        <td>
                          <select class="form-control js-example-basic-single type" style="width:100%" name="type[]" required data-parsley-errors-container="#error-type">
                        ...
                        ?>
                          <select class="form-control js-example-basic-single particular" style="width:100%" name="particular[]" required data-parsley-errors-container="#error-particular">
