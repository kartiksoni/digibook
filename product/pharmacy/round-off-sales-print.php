...
<title>Digibooks | Print Round Of Sales Ledger</title>
	<style type="text/css">
	.panel-title {
...
<body>
  		...
  		<tbody>
  			<tr>
    			<td style="border:none;padding:10px;color:#CC0000;font-size:16px;text-align:center;line-height:20px;">
    				<span style="font-size:18px">Ladger: <b> Round of Sales Ladger </b></span> <br>
	...
	<table align="center" cellpadding="0" cellspacing="0" border="1" width="100%" id="customers" style="line-height:30px;">
  		...
  		<tr style="font-size:14px;font-weight:bold;">
			<td colspan="5" style="text-align:center;"> Total / Closing Balance</td>
