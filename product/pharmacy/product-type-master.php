...
if(isset($_POST['submit'])){
  ...
  $insQry = "INSERT INTO `product_type` (`user_id`, `finance_year_id`, `product_type`, `status`, `created_at`, `created_by`) VALUES ('".$user_id."', '".$financial_year_id."', '".$product_type."', '".$status."', '".date('Y-m-d H:i:s')."', '".$user_id."')";
                  ...
                  <form id="commentForm" class="" method="post" action="">
                    <div class="form-group row">
                        <div class="col-12 col-md-4">
                          ...
                          <input type="text" class="form-control" name="product_type" id="exampleInputName1" placeholder="Product Type" value="<?php echo $edit['product_type']; ?>" required="">
                        </div>
                    </div>    
                    <div class="form-group row">
                      ...
                      <a href="product-type-master.php" class="btn btn-light">Cancel</a>
                      <?php 
                      if(isset($_GET['id'])){
                        ?>
                            ...
                            <div class="col-12">
                              <table id="order-listing1" class="table">
                                ...
                                <tbody>
                                  ...
                                  <?php 
                                  $i = 1;
                                  $financialQry = "SELECT * FROM `product_type` ORDER BY id DESC";
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <a href="product-type-master.php?id=<?php echo $row['id']; ?>" title="edit"><i class="fa fa-edit"></i></a>
                                      </td>
                                  </tr><!-- End Row --> 
                                  <?php 
                                  $i++;
