...
<head>
  ...
  <title>Digibooks | Customer Receipt</title>
  <!-- plugins:css -->
                              ...
                              <select id="deposit_bank" name="deposit_bank_cheque" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-cheque"> 
                                ...
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($customerdata['deposit_bank_cheque']) && $customerdata['deposit_bank_cheque'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                              </select>
                          ...
                          <div class="col-12 col-md-2">
                            ...
                            <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_dd" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-dd"> 
                                ...
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($customerdata['deposit_bank_dd']) && $customerdata['deposit_bank_dd'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group row div_net_banking" <?php if(isset($_REQUEST['id']) && $customerdata['payment_mode'] == "net_banking"){ } else { ?> style="display: none;" <?php } ?>>
                          ...
                          <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_net_banking" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-netbanking"> 
                                ...
                                <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($customerdata['deposit_bank_net_banking']) && $customerdata['deposit_bank_net_banking'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group row div_credit_debit_card" <?php if(isset($_REQUEST['id']) && $customerdata['payment_mode'] == "credit_debit_card") { } else {?>style="display: none;" <?php } ?>>
                          ...
                          <div class="col-12 col-md-2">
                              ...
                              <select id="deposit_bank" name="deposit_bank_credit_debit_card" class="js-example-basic-single deposit_bank" style="width:100%" required="" data-parsley-errors-container="#error-creditcard"> 
                               ...
                               <?php if(isset($allBank) && !empty($allBank)){ ?>
                                    <?php foreach($allBank as $key => $value){ ?>
                                        <option value="<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" <?php echo (isset($customerdata['deposit_bank_credit_debit_card']) && $customerdata['deposit_bank_credit_debit_card'] == $value['id']) ? 'selected' : '';?> ><?php echo (isset($value['name'])) ? $value['name'] : ''; ?></option>
                                    <?php } ?>
                                <?php } ?>
                              </select>
