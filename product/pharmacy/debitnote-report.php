...
<?php 
  ...
  if(isset($_POST['search'])){
    ...
    $searchdata = debitnoteReport($from, $to, $view, 0);
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Digibooks | Debit Note Report</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Debit Note Report</h4><hr class="alert-dark">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-5 col-sm-12">
                        ...
                        <?php if(isset($searchdata)){ ?>
                          <a href="debitnote-report-print.php?from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>&view=<?php echo (isset($_POST['view'])) ? $_POST['view'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                        <?php } ?>
                        </div>
                              ...
                              ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <?php
                                              if($k == 0){
                                                echo (isset($value['debit_note_no'])) ? $value['debit_note_no'] : '';
                                                echo (isset($value['debit_note_date'])) ? '<br/>'.date('d/m/Y',strtotime($value['debit_note_date'])) : '';
                                              }
                                            ?>
                                          </td>
                                          <td>
                              ...
                              <?php if(!empty($searchdata)){ ?>
                                  <?php foreach ($searchdata as $key => $value) { ?>
                                    <tr>
                                      ...
                                      <td>
                                        <?php 
                                          echo (isset($value['debit_note_date']) && $value['debit_note_date'] != '' && $value['debit_note_date'] != '0000-00-00') ? date('d/m/Y',strtotime($value['debit_note_date'])) : ''; 
                                        ?>
                                      </td>
                                      <td><?php echo (isset($value['debit_note_no'])) ? $value['debit_note_no'] : ''; ?></td>
