                            ...
                            <thead>
                              <tr>
                                ...
                                <th>Voucher/Debit Note No</th>
                                 <?php } ?>
                                 <th><?php if((isset($bill_type) && $bill_type == 'summary') && (isset($type) && $type == 'company_wise')){echo "Company Name"; } else if((isset($bill_type) && $bill_type == 'summary') && (isset($sub_type) && $sub_type == 'all1')){ echo "Product Name"; }else{ echo "Product Name";}?></th>
                                <th>Free Qty.</th>
                                <th>Amount</th>
                              </tr> 
                            </thead>
