...
<head>
  ...
  <title>DigiBooks | View Category</title>
  <!-- plugins:css -->
                            ...
                            <div class="col-12">
                              <table id="order-listing1" class="table">
                                ...
                                <tbody>
                                  ...
                                  <?php 
                                  $i = 1;
                                  $financialQry = "SELECT * FROM `user_rights` ORDER BY id DESC";
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <a class="btn  btn-behance p-2" href="add_catagory.php?id=<?php echo $row['id']; ?>" title="edit"><i class="fa fa-pencil mr-0"></i></a>
                                      </td>
                                  </tr><!-- End Row --> 
                                  <?php 
                                  $i++;
