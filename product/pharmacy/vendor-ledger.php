...
<?php 
  ...
  if(isset($_POST['search'])){
    ...
    $searchdata = vendorLedger($vendor, $from, $to);
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Digibooks | Vendor Ledger</title>
  <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Vendor Ledger</h4><hr class="alert-dark">
                    <form class="forms-sample" method="POST" autocomplete="off">
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-3">
                          ...
                          <select class="js-example-basic-single" style="width:100%" name="vendor" id="vendor" data-parsley-errors-container="#error-vendor" required> 
                              <option value="">Please select</option>
                              <?php 
                                $getAllVendorQ = "SELECT id, name FROM ledger_master WHERE status=1 AND group_id=14 AND pharmacy_id = '".$pharmacy_id."' ORDER BY name";
                                $getAllVendorR = mysqli_query($conn, $getAllVendorQ);
                              ?>
                              <?php if($getAllVendorR && mysqli_num_rows($getAllVendorR) > 0){ ?>
                                <?php while ($getAllVendorRow = mysqli_fetch_array($getAllVendorR)) { ?>
                                  <option value="<?php echo $getAllVendorRow['id']; ?>" <?php echo (isset($_POST['vendor']) && $_POST['vendor'] == $getAllVendorRow['id']) ? 'selected' : ''; ?> ><?php echo $getAllVendorRow['name']; ?></option>
                                <?php } ?>
                              <?php } ?>
                          </select>
                        ...
                        <div class="col-12 col-md-5">
                          ...
                          <?php if(isset($searchdata)){ ?>
                            <a href="vendor-ledger-print.php?id=<?php echo (isset($_POST['vendor'])) ? $_POST['vendor'] : ''; ?>&from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                          <?php } ?>
...
<script src="js/custom/vendor_ledger.js"></script>
