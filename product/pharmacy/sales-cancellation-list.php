...
<head>
  ...
  <title>DigiBooks | Cancel List</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Sale Cancel</h4>
                  <hr class="alert-dark">
                  <br>
                  <div class="col">
                       <div class="row">
                            <div class="col-12">
                              <div class="table-responsive">
                                <table class="table datatable">
                                  ...
                                  <tbody>
                                    <?php
                                      $qry = "SELECT tb.id, tb.invoice_date, tb.invoice_no, tb.bill_type, tb.final_amount, lgr.name as customer_name FROM tax_billing tb INNER JOIN ledger_master lgr ON tb.customer_id = lgr.id WHERE tb.cancel = 0 AND tb.pharmacy_id = '".$pharmacy_id."' AND tb.financial_id = '".$financial_id."' ORDER BY tb.id DESC";
