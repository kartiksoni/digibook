                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-2 companyd" <?php if(isset($_POST['company_by']) && $_POST['company_by'] == '0') { } else{ ?> style="display: none;" <?php } ?>>
                          ...
                          <select class="js-example-basic-single" name="company" id="company" style="width:100%" required data-parsley-errors-container="#error-item"> 
                            ...
                            <?php
                              $getcompany = "Select p.company_code,cm.id,cm.name from product_master AS p INNER JOIN company_master AS cm ON p.company_code=cm.id where p.pharmacy_id='$pharmacy_id' GROUP BY  p.company_code";
                              $company = mysqli_query($conn,$getcompany);
                              while($allcompany = mysqli_fetch_assoc($company)){
                            ?>
