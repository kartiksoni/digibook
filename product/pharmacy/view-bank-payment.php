...
<?php 
  ...
  $data = [];
  $query = "SELECT bt.id, bt.amount, bt.voucher_no, bt.voucher_date, bt.payment_mode, lg.name as perticular_name FROM bank_transaction bt LEFT JOIN ledger_master lg ON bt.perticular = lg.id WHERE bt.pharmacy_id = '".$pharmacy_id."' AND bt.financial_id = '".$financial_id."' AND payment_type = 'payment' ORDER BY bt.id DESC";
...
<head>
  ...
  <title>DigiBooks | View Bank Payment</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <a href="bank-payment.php" class="btn btn-success p-2 pull-right" title="Add Bank Payment"><i class="mdi mdi-plus-circle-outline"></i>Add Bank Payment</a>
                  <h4 class="card-title">View Bank Payment</h4>
                  <hr class="alert-dark">
                  <br>
                  <div class="col">
                       <div class="row">
                                    ...
                                    <?php if(isset($data) && !empty($data)){ ?>
                                      <?php foreach ($data as $key => $value) { ?>
                                        <tr>
                                          ...
                                          <td>
                                            <a class="btn btn-behance p-2" href="bank-payment.php?id=<?php echo (isset($value['id'])) ? $value['id'] : ''; ?>" title="edit"><i class="fa fa-pencil mr-0"></i></a>
