                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div id="datepicker-popup1" class="input-group date datepicker">
                                        ...
                                        ?>
                                        <input type="text" value="<?php echo (isset($startdate_val)) ? $startdate_val : ''; ?>" id="start_date" name="start_date" class="form-control" data-parsley-errors-container="#error-startdate" required>
                                ...
                                <div class="col-12 col-md-3">
                                    ...
                                    <div id="datepicker-popup2" class="input-group date datepicker">
                                        ...
                                        ?>
                                        <input type="text" value="<?php echo (isset($enddate_val)) ? $enddate_val : ''; ?>" data-parsley-errors-container="#error-enddate" required  id="end_date" name="end_date" class="form-control">
                                        <span class="input-group-addon input-group-append border-left">
                                            <span class="mdi mdi-calendar input-group-text"></span>
                                        </span>
                                    </div>
