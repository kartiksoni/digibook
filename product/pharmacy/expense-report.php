...
// else{
//  $getallexpense = GetAllExpenseData();
// }
...
<head>
  ...
  <title>Digibooks | Expense Report</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Expense Report</h4><hr class="alert-dark">
                  <form class="forms-sample" method="POST" autocomplete="off">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-2">
                        ...
                        <select class="js-example-basic-single" data-parsley-errors-container="#error-vendor"  style="width:100%" name="transport" id="vendor"> 
                      ...
                      <div class="col-12 col-md-5 col-sm-12">
                        ...
                        <?php if(isset($searchdata)){ ?>
                          <a href="expense-report-print.php?from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>&transport=<?php echo (isset($_POST['transport'])) ? $_POST['transport'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                        <?php } ?>
                        </div>
                              ...
                              <?php if(isset($searchdata) && !empty($searchdata)){ ?>
                                ...
                                ?>
                                  ...
                                  <td class="text-center">
                                    <a class="btn btn-behance p-2" href="expense-master.php?id=<?php echo $value['id'] ?>" title="edit" target="_blank"><i class="fa fa-pencil mr-0"></i></a>
                                  </td>
                                </tr>
                              <?php } ?>
                              <?php } ?>
