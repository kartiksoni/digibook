<?php $title = "Round Of Purchase Ledger"; ?>
...
<?php 
  ...
  if(isset($_POST['search'])){
    ...
    $searchdata = roundoffpurchase($from, $to);
...
<head>
  ...
  <title>Digibooks | Round of purchase Ledger</title>
  <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Round Of Purchase Ledger</h4><hr class="alert-dark">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-5 col-sm-12">
                          ...
                          <?php if(isset($searchdata)){ ?>
                            <a href="round-off-purchase-print.php?from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                          <?php } ?>
    ...
    $("#from, #to").change(function(){
      ...
      if(to !== ''){
          $.ajax({
            type: "POST",
            url: 'ajax.php',
            data: {'from':from, 'to':to, 'action':'roundoffpurchaseRunningBalance'},
            dataType: "json",
