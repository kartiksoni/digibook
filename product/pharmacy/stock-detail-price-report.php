...
<head>
  ...
  <title>Digibooks | Stock Detail Price Report</title>
  <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" autocomplete="off">
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-2">
                          <label for="company">Select Any One</label>
                        ...
                        <div class="col-12 col-md-2 <?php echo (isset($_POST['company']) && $_POST['company'] == 'company_wise') ? 'display-block' : 'display-none'; ?>" id="company-code-div">
                          ...
                          <select class="js-example-basic-single" name="company_code" id="company_code" style="width:100%" data-parsley-errors-container="#error-companycode" required=""> 
                            ...
                            ?>
                              <option value="<?php echo (isset($companyCodeRow['id'])) ? $companyCodeRow['id'] : ''; ?>" <?php echo (isset($_POST['company_code']) && $_POST['company_code'] == $companyCodeRow['id']) ? 'selected' : ''; ?>><?php echo (isset($companyCodeRow['name'])) ? $companyCodeRow['name'] : ''; ?></option>
                            <?php
                                }
                              }
                            ?>
