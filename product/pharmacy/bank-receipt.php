...
<?php 
  ...
  if(isset($_POST['add'])){
    ...
    if($count > 0){
      $voucher_no = getBankTransactionVoucherNo('receipt');
      ...
      for($i=0; $i < $count; $i++) {
        ...
        $query = "INSERT INTO bank_transaction SET financial_id = '".$financial_id."', owner_id = '".$owner_id."', admin_id = '".$admin_id."', pharmacy_id = '".$pharmacy_id."', payment_type = 'receipt', voucher_no = '".$voucher_no."', voucher_date = '".$voucher_date."', bank_id = '".$bank_id."', type = '".$type."', perticular = '".$perticular."', amount = '".$amount."', payment_mode = '".$payment_mode."', payment_mode_date = '".$payment_mode_date."', payment_mode_no = '".$payment_mode_no."', card_name = '".$card_name."', other_reference = '".$other_reference."', reverse_charge = '".$reverse_charge."', gst = '".$gst."', batch = '".$batch."', created = '".date('Y-m-d H:i:s')."', createdby = '".$_SESSION['auth']['id']."'";
        $res = mysqli_query($conn, $query);
      }
      $_SESSION['msg']['success'] = "Bank Receipt Added Successfully.";
      header('Location: view-bank-receipt.php');exit;
    }else{
      $_SESSION['msg']['fail'] = "At least one transaction is required!";
      header('Location: bank-receipt.php');exit;
    }
  ...
  if(isset($_GET['id']) && $_GET['id'] != ''){
    $query = "SELECT * FROM bank_transaction WHERE pharmacy_id = '".$pharmacy_id."' AND financial_id = '".$financial_id."' AND id = '".$_GET['id']."' AND payment_type = 'receipt'";
    $res = mysqli_query($conn, $query);
...
<body>
                  ...
                  <div class="card-body">
                    <div class="row form-group">
                      <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="voucher_no" name="voucher_no" placeholder="Voucher No." value="<?php echo (isset($editData['voucher_no'])) ? $editData['voucher_no'] : getBankTransactionVoucherNo('receipt'); ?>" required readonly>
                      </div>
                      <div class="col-md-2">
                ...
                <div class="card">
                  <div class="card-body">
                      ...
                      <div class="detail-row">
                        ...
                        <?php }else{ ?>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-md-2 offset-md-6 text-right" style="padding-top: 30px;">
                    ...
                    <div id="detail-footer">
                      <a href="view-bank-receipt.php" class="btn btn-light">Back</a>
  ...
  <!-- page js -->
  <script src="js/custom/bank-payment.js"></script>
