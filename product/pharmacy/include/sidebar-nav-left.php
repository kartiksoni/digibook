...
<div class="collapse" id="page-layouts">
    <ul class="nav flex-column sub-menu">
        <li class="nav-item"> <a class="nav-link" href="ledger-management.php">Ledger Management</a></li>-->
        ...
        <li class="nav-item"> <a class="nav-link" href="notification-master.php">Notification Master</a></li>-->
        <!--<li class="nav-item"> <a class="nav-link" href="vendor-bank-managment.php">Bank Management</a></li>-->
        <!--<li class="nav-item"> <a class="nav-link" href="bill-note.php">Bill Notes</a></li>
...
<li class="nav-item">
    <a class="nav-link" href="accounting-cash-management.php">
