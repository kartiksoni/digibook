                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="companyname" name="companyname" placeholder="Person Name" >
                        </div>
                      </div>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" name="panno" placeholder="Pan No" id ="pan_num" value="" data-parsley-pattern="[A-Za-z]{5}\d{4}[A-Za-z]{1}" data-parsley-pattern-message="Enter valid PAN No." readonly>
                      </div>
