...
if(isset($_POST['submit'])){  
  ...
  if(!empty($user_rights_data)){
    $UpdateQty = "UPDATE `user_rights` SET `catagory_name`='".$catagory_name."',`module`='".$module."',`sub_module`='".$sub_module."',`update_at`='".date('Y-m-d H:i:s')."',`updated_by`='".$admin_id."' WHERE admin_id='".$admin_id."'";
    ...
    $inQty = "INSERT INTO `user_rights`(`admin_id`,`catagory_name`, `module`,`sub_module`,`cretaed_at`, `created_by`) VALUES ('".$admin_id."','".$catagory_name."','".$module."','".$sub_module."','".date('Y-m-d H:i:s')."','".$admin_id."')";
...
<head>
  ...
  <title>DigiBooks | Add Category</title>
  <!-- plugins:css -->
