        ...
        if($type == 'sale'){
            ...
            if($res && mysqli_num_rows($res) > 0){
                while ($row = mysqli_fetch_assoc($res)){
                    ...
                    $freight_tax = 0;
                    if($gst != 'igst'){
                        if($row['freight_amount'] != '' && $row['freight_amount'] != 0 && $row['tax_rate'] == ($row['freight_per']/2)){
