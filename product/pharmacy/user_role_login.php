...
if(isset($_POST['submit'])){
  ...
  $status = $_POST['status'];
  $url = BASE_URL."?action=admin_user_add&name=$user_name&owner_id=$owner_id&pharmacy_id=$pharmacy_id&admin_id=$admin_id&user_type=user&user_role=$catagory_id&user_name=$user_name&email=$email&mobile=$mobile&password=$password&type=PHARMACY&status=$status";
...
<head>
  ...
  <title>DigiBooks | Add User</title>
  <!-- plugins:css -->
