...
$searchdata = $searchdata = debitnoteReport($from, $to, $view, 0);
...
<head>
  ...
  <title>Digibooks | Print Debit Note Report</title>
  <style type="text/css">
  .panel-title {
      ...
      <tbody>
        <tr>
          <td style="border:none;padding:10px;color:#CC0000;font-size:16px;text-align:center;line-height:20px;">
            <span style="font-size:18px"><b> Debit Note Report - <?php echo (isset($_GET['view'])) ? ucwords($_GET['view']) : ''; ?> </b></span>
          </td>
        </tr>
      </tbody>
    </table>
                    ...
                    <td>
                      <?php
                        if($k == 0){
                          ...
                          echo (isset($value['debit_note_date'])) ? ' | '.$value['debit_note_date'] : '';
                        }
                      ?>
                    </td>
                    <td>
