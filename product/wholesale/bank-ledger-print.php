...
<?php 
	...
	$bank = (isset($_GET['id'])) ? $_GET['id'] : '';

	$pharmacy = getPharmacyDetail();
	$data = bankLedger($bank, $from, $to);
?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Digibooks | Print Bank Ledger</title>
	<style type="text/css">
	.panel-title {
  		...
  		<tbody>
  			<tr>
    			<td style="border:none;padding:10px;color:#CC0000;font-size:16px;text-align:center;line-height:20px;">
    				<span style="font-size:18px">Bank Ledger : <b> <?php echo (isset($data['bank_name'])) ? $data['bank_name'] : 'Unknown Bank'; ?> </b></span>
      			</td>
  			</tr>
		</tbody>
		</table>
