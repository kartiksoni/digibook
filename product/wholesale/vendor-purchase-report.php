                    ...
                    <form class="forms-sample" method="POST" autocomplete="off">
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-2">
                          ...
                          <select class="form-control" name="city" id="city" style="width:100%" data-parsley-errors-container="#error-city" required>
                            <?php 
                        ...
                        <div class="col-12 col-md-2">
                          ...
                          <select class="js-example-basic-single form-control" name="vendor" id="vendor" style="width:100%" data-parsley-errors-container="#error-vendor" required>
