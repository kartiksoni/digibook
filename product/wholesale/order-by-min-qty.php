                            ...
                            <tbody>
                              <?php $i=1; if(isset($allproduct) && !empty($allproduct)){ ?>
                                <?php foreach ($allproduct as $key => $value) { ?>
                                    <tr>
                                      <td><?php echo $i; ?></td>
                                      <td><?php echo (isset($value['product_name'])) ? $value['product_name'] : 'Unknown Product'; ?></td>
                                      <td><?php echo (isset($value['company_code'])) ? $value['company_code'] : ''; ?></td>
                                      <td><?php echo (isset($value['min_qty'])) ? $value['min_qty'] : 0; ?></td>
                                      <td><?php echo (isset($value['currentstock'])) ? $value['currentstock'] : 0; ?></td>
                                      <td><?php echo (isset($value['suggested_qty'])) ? $value['suggested_qty'] : 0; ?></td>
                                    </tr>
                                  <?php $i++; ?>
                                <?php } ?>
                              <?php } ?>
