        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <a href="delivery-challan.php" class="btn btn-success p-2 pull-right" title="Add Bill"><i class="mdi mdi-plus-circle-outline"></i>Add Bill</a>
                            ...
                            <div class="col-12">
                              <div class="table-responsive">
                                <table class="table datatable">
                                  ...
                                  <tbody>
                                    <?php
                                      $qry = "SELECT dc.id, dc.invoice_date, dc.invoice_no, dc.bill_type, dc.customer_name, dc.is_general_sale, dc.final_amount, lgr.name as l_customer_name FROM delivery_challan dc LEFT JOIN ledger_master lgr ON dc.customer_id = lgr.id WHERE dc.pharmacy_id = '".$pharmacy_id."' AND dc.financial_id = '".$financial_id."' ORDER BY dc.id DESC";
