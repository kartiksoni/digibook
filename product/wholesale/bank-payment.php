...
<?php 
  ...
  if(isset($_POST['add'])){
    ...
    if($count > 0){
      $voucher_no = getBankTransactionVoucherNo('payment');
  ...
  if(isset($_POST['update'])){
    ...
    if($res){
      ...
      $_SESSION['msg']['fail'] = "Bank Payment Added Fail!";
      header('Location: bank-payment.php');exit;
    }
  ...
  if(isset($_GET['id']) && $_GET['id'] != ''){
    $query = "SELECT * FROM bank_transaction WHERE pharmacy_id = '".$pharmacy_id."' AND financial_id = '".$financial_id."' AND id = '".$_GET['id']."' AND payment_type = 'payment'";
    $res = mysqli_query($conn, $query);
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="detail-footer">
                      <a href="view-bank-payment.php" class="btn btn-light">Back</a>
