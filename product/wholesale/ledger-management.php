                  ...
                  <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-4">
                        <label for="name"><?php if (isset($_GET['subtype']) && in_array($_GET['subtype'], [5,22])) { ?>
                                Bank Name
                             <?php } else if (isset($_GET['subtype']) && in_array($_GET['subtype'], [10,14])) { ?>
                               Company Name 
                            <?php } else { ?>
                            Account Name <?php } ?> <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="name" placeholder="<?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [5,22])) ? 'Bank Name' : 'Account Name'; ?>" value="<?php echo (isset($ledgerdata['name'])) ? $ledgerdata['name'] : ''; ?>" data-parsley-pattern="^[A-Za-z -.,:'_]*$"  data-parsley-pattern-message="Enter only alphabets and specific symbols." Required>
                      </div>
                      
                      <div class="col-12 col-md-4 <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [12,26,27,5,22])) ? 'display-none' : 'display-block'; ?>">
                      ...
                      <input type="text" class="form-control onlyalphabet" name="designation" value="<?php echo (isset($ledgerdata['designation'])) ? $ledgerdata['designation'] : ''; ?>" placeholder="Designation">
                      </div>
                      ...
                      <div class="col-12 col-md-4 m-t-20 <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [10,14])) ? 'display-block' : 'display-none'; ?>">
                        ...
                        <label for="customer_type">Vender Type <span class="text-danger">*</span></label>
                   ...
                   <div class="col-12 col-md-4 m-t-20 gstno-div <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [10,14]) || (isset($ledgerdata['customer_role']) && $ledgerdata['customer_role'] == 'Reseller')) ? 'display-block' : 'display-none'; ?>">
                        ...
                        <?php 
                        if(in_array($_GET['subtype'], [10,14])){
                        ?>
                       ...
                       <div class="col-12 col-md-4 m-t-20 panno-div <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [10,14]) || (isset($ledgerdata['customer_role']) && $ledgerdata['customer_role'] == 'Reseller')) ? 'display-block' : 'display-none'; ?>">
                        ...
                        <input type="text" class="form-control" id="pan_no" name="panno" placeholder="Pan No" value="<?php echo (isset($ledgerdata['panno'])) ? $ledgerdata['panno'] : ''; ?>" data-parsley-pattern="[A-Za-z]{5}\d{4}[A-Za-z]{1}" data-parsley-pattern-message="Enter valid PAN No.">
                   ...
                   <?php if (isset($_GET['subtype']) && in_array($_GET['subtype'], [10,14])) { ?>
                    ...
                    <?php } ?>  
                      ...
                      <div class="col-12 col-md-4 <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [12,26,27,5,22])) ? 'display-none' : 'display-block'; ?>">
                        ...
                        <input type="text" name="mobile" class="form-control onlynumber" data-parsley-type="number" data-parsley-length="[10, 10]" maxlength="10" data-parsley-length-message = "Mobile No should be 10 charatcers long." placeholder="Mobile No" value="<?php echo (isset($ledgerdata['mobile'])) ? $ledgerdata['mobile'] : ''; ?>" required>
                      </div>
                      <div class="col-12 col-md-4 <?php echo (isset($_GET['subtype']) && in_array($_GET['subtype'], [12,26,27,5,22])) ? 'display-none' : 'display-block'; ?>">
                        <label for="phone">Phone No </label>
                      <input type="text" class="form-control onlynumber" name="phone" placeholder="Phone No" value="<?php echo (isset($ledgerdata['phone'])) ? $ledgerdata['phone'] : ''; ?>">
                      </div>
