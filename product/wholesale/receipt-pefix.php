...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $existQ = "SELECT id FROM receipt_pefix WHERE pharmacy_id = '".$pharmacy_id."'";
        $existR = mysqli_query($conn, $existQ);
        if($existR && mysqli_num_rows($existR) > 0){
            $existRow = mysqli_fetch_assoc($existR);
            $updateQ = "UPDATE receipt_pefix SET pefix_name_cash = '".$pefix_cash."', pefix_name_debit = '".$pefix_debit."'";
            ...
            $insertQ = "INSERT INTO receipt_pefix SET pharmacy_id = '".$pharmacy_id."', pefix_name_cash = '".$pefix_cash."', pefix_name_debit = '".$pefix_debit."'";
        ...
        header('location:receipt-pefix.php');exit;
    }
    
    $getPrifixQ = "SELECT id, pefix_name_cash, pefix_name_debit FROM receipt_pefix WHERE pharmacy_id = '".$pharmacy_id."'";
...
<head>
  ...
  <title>Digibooks | Receipt Prifix</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Receipt Pefix</h4><hr class="alert-dark"><br>
                  <form method="post">
                    <div class="row form-group">
                        <div class="col-12 col-md-4">
                            <lable>Receipt Pefix(Cash)</lable>
                        ...
                        <div class="col-12 col-md-4">
                            <lable>Receipt Pefix(Debit)</lable>
