                  ...
                  <!-- Main Catagory -->
                    ...
                    ?>      
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-4">
                          <label for="exampleInputName1">Reverse charge</label>
                          <div class="row no-gutters">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <!-- Row Starts --> 	
                              <tr>
                                <td>
                                  <input type="text" class="form-control credit_debit" readonly required="" name="credit_debit" value="<?php if (isset($_REQUEST['id']) && $accountdatarecord['credit_debit']) {echo ucfirst($accountdatarecord['credit_debit']);}else{echo "Debit";} ?>" >
                                ...
                                <td>
                                  <select class="js-example-basic-single" name="group" style="width:100%" id="group" required="" data-parsley-errors-container="#error-container"> 
                                    <option value="">Please Select</option>
                                      <?php
                                        $dataqry = "SELECT * FROM `group` WHERE id NOT IN ('5','22')";
