                  ...
                  <div class="row">
                    <div class="col-12">
                        <div class="purchase-top-btns">
                            ...
                            <?php }
                            if((isset($user_sub_module) && in_array("View Sales Bill", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                                ?>
                            ...
                            <form id="sales-order-final-form" method="POST">
                              ...
                              <table class="table">
                                <tr>
                                  ...
                                  <td class="text-right">
                                    <button type="submit" class="btn btn-success btn-saveproduct" style="margin-top:30px;">Save</button>
                                  </td>
                                </tr>
                              </table>
  ...
  <div id="addproduct-tr-html" class="display-none">
    <table>
      <tr id="##DATAID##">
        ...
        <td>
          <button class="btn  btn-danger p-2 edit-temp" data-id="##ID##"><i class="icon-pencil mr-0"></i></button>
          <button class="btn  btn-primary p-2 delete-temp" data-id="##ID##"><i class="icon-trash mr-0"></i></button>
        </td>
      </tr>
    </table>
  </div>
