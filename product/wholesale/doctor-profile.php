...
if(isset($_POST['submit']))
{
    ...
    if(isset($_REQUEST['id']) && $_REQUEST['id'] != '')
    {
        ...
        $doctoraddqry = "INSERT INTO `doctor_profile`(`owner_id`,`admin_id`,`pharmacy_id`,`financial_id`, `personal_title`, `name`, `shortname`, `mobile`, `commission`, `country`, `state`, `city`, `address`, `pincode`, `status`, `created`, `createdby`, `modified`) VALUES ('".$owner_id."', '".$admin_id."', '".$pharmacy_id."','".$financial_id."', '".$title."', '".$doctor."', '".$short."', '".$mobile."', '".$commission."', '".$country."', '".$state."', '".$city."', '".$address."', '".$pincode."', '".$status."', '".date('Y-m-d H:i:s')."', '".$user_id."', '".date('Y-m-d H:i:s')."')";
