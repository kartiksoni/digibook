        ...
        <form id="add-doctor-form" autocomplete="off">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-12 col-md-4">
                <label for="email">Doctor Commition <span class="text-danger">*</span></label>
                <input type="text" class="form-control onlynumber" name="doctor_commossion" placeholder="Commission %" maxlength="3" required>   
              </div>
