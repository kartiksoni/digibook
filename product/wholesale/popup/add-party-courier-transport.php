        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
           ...
           <div class="col-12 col-md-4">
             ...
             <input type="text" name="mobile_no" class="form-control onlynumber" id="exampleInputName1" placeholder="Mobile No" data-parsley-type="number" data-parsley-length="[10, 10]" data-parsley-length-message = "Mobile No should be 10 charatcers long." required="" value="<?php if(isset($_REQUEST['id'])){echo 
