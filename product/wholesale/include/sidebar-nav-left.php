<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
            ...
            <div class="nav-link d-flex">
                <div class="profile-image">
                    <?php if(isset($_SESSION['auth']['profile_pic']) && !empty($_SESSION['auth']['profile_pic']) ){ ?>
                        <img src="https://digibooks.cloud/product/user_profile/<?php echo $_SESSION['auth']['profile_pic']; ?>" alt="image"/>
                    <?php }else{ ?>
                ...
                <div class="profile-name">
                    <p class="name">
                        <?php echo ucfirst(strtolower($_SESSION['auth']['name'])); ?>(<?php echo ucfirst(strtolower($_SESSION['auth']['user_type'])); ?>)
                        <?php 
        ...
        <div id="sidebar-menu">
            ...
            <?php 
            if((isset($user_module) && in_array("Chat", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
            ?>
            <li class="nav-item">
            ...
            //if($_SESSION['auth']['user_type'] == "admin"){
                ?>
                <?php 
                if((isset($user_module) && in_array("User Catagory", $user_module))){
                ?>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="cat">
                        <ul class="nav flex-column sub-menu">
                            <?php 
                            if((isset($user_sub_module) && in_array("Add Catagory", $user_sub_module))){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="add_catagory.php">Add Catagory</a></li>
                            <?php }
                            if((isset($user_sub_module) && in_array("View Catagory", $user_sub_module))){
                            ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("User Master", $user_module))){
                ?>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="user_master">
                        <ul class="nav flex-column sub-menu">
                            <?php
                            if((isset($user_sub_module) && in_array("Add User", $user_sub_module))){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="user_role_login.php">Add User</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("View User", $user_sub_module))){
                            ?>
            ...
            if((isset($user_module) && in_array("Configuration", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){ 
            ?>
            <li class="nav-item">
            ...
            /*Ownwer Condistion Start*/
                if((isset($user_module) && in_array("Inventory", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <li class="nav-item">
                ...
                <?php } 
                if((isset($user_module) && in_array("Purchase", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <li class="nav-item">
                ...
                <?php } 
                if((isset($user_module) && in_array("Delievery Challan", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <div class="collapse" id="delievery-challan">
                    <ul class="nav flex-column sub-menu">
                        <?php 
                        if((isset($user_sub_module) && in_array("Add challan", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                        ?>
                        <li class="nav-item"> <a class="nav-link" href="#">Add challan</a></li>
                        <?php } 
                        if((isset($user_sub_module) && in_array("View challan", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                        ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("Sell", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                    ...
                    <div class="collapse" id="sales">
                        <ul class="nav flex-column sub-menu">
                            <?php if((isset($user_sub_module) && in_array("Tax Billing", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){ ?>
                                ...
                                <li class="nav-item"> <a class="nav-link" href="bill-of-supply.php">Bill of Supply</a></li>
                                <li class="nav-item"> <a class="nav-link" href="sale_of_service.php">Service Bill</a></li>
                ...
                <?php } 
                if((isset($user_module) && in_array("Transaction", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("Leads", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("Order Place", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("Reports", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="reports">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <!--<?php
                            if((isset($user_sub_module) && in_array("Daily Sales Reports", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="daily-sales-report.php">Daily Sales Reports</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("P & L Account Reports", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            ...
                            <li class="nav-item"><a class="nav-link" href="vendor-purchase-report.php">Vendor Purchase Report</a></li>
                            <li class="nav-item"><a class="nav-link" href="journal-voucher-register.php">Journal Voucher Register Report</a></li>
                            <li class="nav-item"><a class="nav-link" href="ledger-summary-report.php">Ledger Summary Report</a></li>
                            <li class="nav-item"><a class="nav-link" href="sell-report.php">Sales</a></li>
                            <li class="nav-item"><a class="nav-link" href="freight-courier-report.php">Freight Courier Report</a></li>-->
                        </ul>
                    </div>
                </li>
                ...
                <?php } 
                if((isset($user_module) && in_array("Branch", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                ...
                <?php } 
                if((isset($user_module) && in_array("Courier-Transport", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ledgers">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <?php } 
                            if((isset($user_sub_module) && in_array("Cash Ledger", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){ 
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="cash-ledger.php">Cash Ledger</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("Bank Ledger", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="bank-ledger.php">Bank Ledger</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("Round Off Sales Ledger", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="round-off-sales-ledger.php">Round Off Sales Ledger</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("Round Off Purchase Ledger", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="round-off-purchase-ledger.php">Round Off Purchase Ledger</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("All Ledger", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                             <li class="nav-item"> <a class="nav-link" href="all-group-ledger.php">All Ledger</a></li>
                            <?php } ?>
                            
                            <li class="nav-item"> <a class="nav-link" href="freight-courier-ledger.php">Freight/Courier Ledger</a></li>
                            <li class="nav-item"> <a class="nav-link" href="discount-ledger.php">Discount Ledger</a></li>
                        </ul>
                    </div>
                </li>
            <?php }  ?>
            ...
            <li class="nav-item">
                    ...
                    <div class="collapse" id="credit_note">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <?php } 
                            if((isset($user_sub_module) && in_array("Other", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
            ...
            <?php } 
            if((isset($user_module) && in_array("Debit Note", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
            ?>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="debit_note">
                        <ul class="nav flex-column sub-menu">
                            <?php 
                            if((isset($user_sub_module) && in_array("Purchase Retun", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
            ...
            <?php } 
            if((isset($user_module) && in_array("Help Desk", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
            ?>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="help-desk">
                        <ul class="nav flex-column sub-menu">
                            <?php
                            if((isset($user_sub_module) && in_array("Add Help Desk", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="help-desk.php">Add Help Desk</a></li>
                            <?php } 
                            if((isset($user_sub_module) && in_array("Product Name Wise", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="#">Product Name Wise</a></li>
                            <?php 
                            }
                            if((isset($user_sub_module) && in_array("Vendor wise", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="#">Vendor wise</a></li>
                            <?php 
                            }
                            if((isset($user_sub_module) && in_array("Company wise", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
            ...
            <?php //if($_SESSION['auth']['user_type'] != "owner"){ ?>
                <?php
                if((isset($user_module) && in_array("Stock Report", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <!--<li class="nav-item">
                    ...
                    <div class="collapse" id="stockreport">
                        <ul class="nav flex-column sub-menu">
                            <?php
                            if((isset($user_sub_module) && in_array("Stock Detail Quantity", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                            <li class="nav-item"><a class="nav-link" href="stock-detail-qty-report.php">Stock Detail Quantity</a></li>
                            <?php } ?>
                            <?php
                            if((isset($user_sub_module) && in_array("Stock Detail Price", $user_sub_module)) || $_SESSION['auth']['user_type'] == "owner"){
                            ?>
                ...
                <?php } ?>
                <?php
                if((isset($user_module) && in_array("Hospital Prescription", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <!--<li class="nav-item">
                ...
                <?php } ?>
                <?php
                if((isset($user_module) && in_array("Remider List", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){
                ?>
                <!--<li class="nav-item">
            ...
            <?php if((isset($user_module) && in_array("Quotation/ Estimate/ Proformo Invoice", $user_module)) || $_SESSION['auth']['user_type'] == "owner"){ ?>
             <li class="nav-item">
                    <a class="nav-link" href="quotation.php">
                    <i class="icon-file menu-icon"></i>
                    <span class="menu-title">Quotation/ Estimate/ Proformo Invoice</span>
                    </a>
             </li>
            <?php } ?>    
