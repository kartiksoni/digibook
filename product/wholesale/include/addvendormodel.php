<div class="modal fade" id="purchase-addvendormodel" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <form id="add-vendor" autocomplete="off">
                  <div class="modal-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control onlyalphabet" id="companyname" name="companyname" placeholder="Person Name" >   
                      </div>
                      ...
                      <div class="col-12 col-md-4">
                        <label for="opening_balance_type">Opening Balance Type</label>
                          <select class="form-control" style="width:100%" name="opening_balance_type" data-parsley-errors-container="#opening_balance_type" > 
                      ...
                      <div class="col-12 col-md-4">
                       ...
                       <div class="col-12 col-md-4">
                        ...
                        <select class="form-control customer_type" name="customer_type" style="width:100%" data-parsley-errors-container="#error-ven-customer" required>
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control gstno" name="gstno" placeholder="GST No" id= "gst_no" value="" data-parsley-pattern="^([0]{1}[1-9]{1}|[1-2]{1}[0-9]{1}|[3]{1}[0-7]{1})([a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9a-zA-Z]{1}[zZ]{1}[0-9a-zA-Z]{1})+$" data-parsley-pattern-message="Enter valid GST No." maxlength="15" >
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" name="panno" placeholder="Pan No"  id ="pan_num" value="" data-parsley-pattern="[A-Za-z]{5}\d{4}[A-Za-z]{1}" data-parsley-pattern-message="Enter valid PAN No." required>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-4">
                        <label for="city">Select City <span class="text-danger">*</span></label>
                          <select class="js-example-basic-single" style="width:100%" name="city" id="vendorcity" data-parsley-errors-container="#error-ven-city" required> 
                      ...
                      <div class="col-12 col-md-3">
                          ...
                          <select class="js-example-basic-single" id="Area" name="area_name" style="width:100%" data-parsley-errors-container="#error-ven-area" >
                              ...
                              while($row = mysqli_fetch_array($result)){
                                  ?>
                              <option <?php if(isset($data['company_code']) && $data['company_code'] == $row['id']){echo "selected";} ?> value="<?php echo $row['id']; ?>"><?php echo $row['area_name']; ?></option>
                                  <?php
                              }
                              ?>
                          </select>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control onlynumber" name="bank_ac_no" placeholder="Bank A/c No" value="" >
                      </div>
