<?php $title="Sales Order Estimate"; ?>
...
<body>
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <div class="sales-filter-btns-right display-3" style="display:inline-block">
                        ...
                        <a href="sales-order-estimate.php" class="btn btn-primary-light-green btn-xs active">Estimate</a>
  ...
  <script src="js/custom/sales_order_estimate.js"></script>
