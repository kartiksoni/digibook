              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td colspan="3" class="GST"><b>GST<div class="arrow-down"></div></b></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <div class="gst_class">
                    ...
                    <table class="table table-bordered">
                      <tr>
                        <td width="50%"><b style=" margin-left: 10px;">Purchase</b></td>
                    ...
                    <table class="table table-bordered">
                      <tr>
                        <td width="50%"><b style=" margin-left: 10px;">Sale</b></td>
                        <td width="25%" class="text-right">
                          <b style=" margin-left: 10px;">
                            <?php 
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      <tr>
                        <td colspan="3" class="IGST"><b>IGST<div class="arrow-down"></div></b></td>
                      </tr>
                    </tbody>
                  </table>

                  <div class="igst_class">
                    <table class="table table-bordered">
                      <tr>
                        <td width="50%"><b style=" margin-left: 10px;">Purchase</b></td>
                        <td width="25%" class="text-right">
