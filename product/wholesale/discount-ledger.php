...
<?php 
  ...
  if(isset($_POST['search'])){
    ...
    $searchdata = getDiscountLedger($from, $to, 0);
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Digibooks | Discount Ledger</title>
  <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Discount Ledger</h4><hr class="alert-dark">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-5 col-sm-12">
                          ...
                          <?php if(isset($searchdata)){ ?>
                            <a href="discount-ledger-print.php?from=<?php echo (isset($_POST['from'])) ? $_POST['from'] : ''; ?>&to=<?php echo (isset($_POST['to'])) ? $_POST['to'] : ''; ?>" class="btn btn-primary mt-30" title="Print" target="_blank">Print</a>
                          <?php } ?>
                        </div>
