...
?>
<!-------------------------------------------- CODE FOR ADD AND UPDATE DELIVERY CHALLAN START ----------------------------------------------->
<?php

  if(isset($_POST['save']) || isset($_POST['saveAndNext']) || isset($_POST['saveAndPrint'])){
    $delivery_challan['invoice_date'] = (isset($_POST['invoice_date']) && $_POST['invoice_date'] != '') ? date('Y-m-d',strtotime(str_replace('/','-',$_POST['invoice_date']))) : NULL;
    if(isset($_GET['id']) && $_GET['id'] != '' ){
        $delivery_challan['invoice_no'] = (isset($_POST['invoice_no'])) ? $_POST['invoice_no'] : '';
    }else{
        $delivery_challan['invoice_no'] = getChallanInvoiceNo((isset($_POST['bill_type'])) ? $_POST['bill_type'] : '');
    }
    $delivery_challan['city_id'] = (isset($_POST['customer_city'])) ? $_POST['customer_city'] : NULL;
    $delivery_challan['statecode'] = (isset($_POST['statecode'])) ? $_POST['statecode'] : NULL;
    
    // $tax_billing['customer_id'] = findCustomer($_POST);
    $delivery_challan['customer_name'] = (isset($_POST['customer_name'])) ? $_POST['customer_name'] : '';
    $delivery_challan['customer_id'] = (isset($_POST['customer_id'])) ? $_POST['customer_id'] : '';
    $delivery_challan['is_general_sale'] = (isset($_POST['is_general_sale']) && $_POST['is_general_sale'] != '') ? $_POST['is_general_sale'] : 0;
    
    $delivery_challan['lr_no'] = (isset($_POST['lr_no'])) ? $_POST['lr_no'] : '';
    $delivery_challan['lr_date'] = (isset($_POST['lr_date']) && $_POST['lr_date'] != '') ? date('Y-m-d',strtotime(str_replace('/','-',$_POST['lr_date']))) : '';
    $delivery_challan['transporter_id'] = (isset($_POST['transporter_id'])) ? $_POST['transporter_id'] : '';
    $delivery_challan['motor_vehicle_no'] = (isset($_POST['motor_vehicle_no'])) ? $_POST['motor_vehicle_no'] : '';
    $delivery_challan['buyer_order_no'] = (isset($_POST['buyer_order_no'])) ? $_POST['buyer_order_no'] : '';
    $delivery_challan['buyer_date'] = (isset($_POST['buyer_date']) && $_POST['buyer_date'] != '') ? date('Y-m-d',strtotime(str_replace('/','-',$_POST['buyer_date']))) : '';
    
    $delivery_challan['bill_type'] = (isset($_POST['bill_type'])) ? $_POST['bill_type'] : '';
    $delivery_challan['alltotalamount'] = (isset($_POST['alltotalamount']) && $_POST['alltotalamount'] != '') ? $_POST['alltotalamount'] : 0;
    $delivery_challan['total_return_amount'] = (isset($_POST['total_return_amount']) && $_POST['total_return_amount'] != '') ? $_POST['total_return_amount'] : 0;
    $delivery_challan['couriercharge'] = (isset($_POST['couriercharge']) && $_POST['couriercharge'] != '') ? $_POST['couriercharge'] : 0;
    $delivery_challan['couriercharge_val'] = (isset($_POST['couriercharge_val']) && $_POST['couriercharge_val'] != '') ? $_POST['couriercharge_val'] : 0;
    $delivery_challan['totaltaxgst'] = (isset($_POST['totaltaxgst']) && $_POST['totaltaxgst'] != '') ? $_POST['totaltaxgst'] : 0;
    $delivery_challan['totaligst'] = (isset($_POST['totaligst']) && $_POST['totaligst'] != '') ? $_POST['totaligst'] : 0;
    $delivery_challan['totalcgst'] = (isset($_POST['totalcgst']) && $_POST['totalcgst'] != '') ? $_POST['totalcgst'] : 0;
    $delivery_challan['totalsgst'] = (isset($_POST['totalsgst']) && $_POST['totalsgst'] != '') ? $_POST['totalsgst'] : 0;
    $delivery_challan['discount_type'] = (isset($_POST['discount_type'])) ? $_POST['discount_type'] : '';
    $delivery_challan['discount_per'] = (isset($_POST['discount_per']) && $_POST['discount_per'] != '') ? $_POST['discount_per'] : 0;
    $delivery_challan['discount_rs'] = (isset($_POST['discount_rs']) && $_POST['discount_rs'] != '') ? $_POST['discount_rs'] : 0;
    $delivery_challan['overalldiscount'] = (isset($_POST['overalldiscount']) && $_POST['overalldiscount'] != '') ? $_POST['overalldiscount'] : 0;
    $delivery_challan['cr_db_type'] = (isset($_POST['cr_db_type']) && $_POST['cr_db_type'] != '') ? $_POST['cr_db_type'] : '';
    $delivery_challan['cr_db_val'] = (isset($_POST['cr_db_val']) && $_POST['cr_db_val'] != '') ? $_POST['cr_db_val'] : 0;
    $delivery_challan['purchase_amount'] = (isset($_POST['purchase_amount']) && $_POST['purchase_amount'] != '') ? $_POST['purchase_amount'] : 0;
    $delivery_challan['roundoff_amount'] = (isset($_POST['roundoff_amount']) && $_POST['roundoff_amount'] != '') ? $_POST['roundoff_amount'] : 0;
    $delivery_challan['final_amount'] = (isset($_POST['final_amount']) && $_POST['final_amount'] != '') ? $_POST['final_amount'] : 0;
    $delivery_challan['remarks'] = (isset($_POST['remarks'])) ? $_POST['remarks'] : '';
    $delivery_challan['salesman_id'] = (isset($_POST['salesman_id'])) ? $_POST['salesman_id'] : NULL;

    if(isset($_GET['id']) && $_GET['id']){
      $query = "UPDATE delivery_challan SET ";
    }else{
      $query = "INSERT INTO delivery_challan SET financial_id = '".$financial_id."', owner_id = '".$owner_id."', admin_id = '".$admin_id."', pharmacy_id = '".$pharmacy_id."',";
    }
    ...
    $challanRes = mysqli_query($conn, $query);
    if($challanRes){
      $challanid = (isset($_GET['id']) && $_GET['id'] != '') ? $_GET['id'] : mysqli_insert_id($conn);
      if($challanid != ''){
        $deleteOldItemQ = "DELETE FROM delivery_challan_details WHERE challan_id = '".$challanid."'";
        mysqli_query($conn, $deleteOldItemQ);

        /*-----------------------------------SAVE DELIVERY CHALLAN ITEMS START----------------------------------------------*/
        $count = (isset($_POST['product_id']) && !empty($_POST['product_id'])) ? count($_POST['product_id']) : 0;
        if($count != 0){
          for ($i=0; $i < $count; $i++) { 
            $delivery_challan_details['challan_id'] = $challanid;
            $delivery_challan_details['product_id'] = (isset($_POST['product_id'][$i])) ? $_POST['product_id'][$i] : '';
            $delivery_challan_details['mrp'] = (isset($_POST['mrp'][$i]) && $_POST['mrp'][$i] != '') ? $_POST['mrp'][$i] : 0;
            $delivery_challan_details['mfg_co'] = (isset($_POST['mfg_co'][$i])) ? $_POST['mfg_co'][$i] : '';
            $delivery_challan_details['batch'] = (isset($_POST['batch'][$i])) ? $_POST['batch'][$i] : '';
            $delivery_challan_details['expiry'] = (isset($_POST['expiry'][$i]) && $_POST['expiry'][$i] != '') ? date('Y-m-d',strtotime(str_replace('/','-',$_POST['expiry'][$i]))) : NULL;
            $delivery_challan_details['qty'] = (isset($_POST['qty'][$i]) && $_POST['qty'][$i] != '') ? $_POST['qty'][$i] : 0;
            $delivery_challan_details['qty_ratio'] = (isset($_POST['qty_ratio'][$i]) && $_POST['qty_ratio'][$i] != '') ? $_POST['qty_ratio'][$i] : 0;
            $delivery_challan_details['freeqty'] = (isset($_POST['freeqty'][$i]) && $_POST['freeqty'][$i] != '') ? $_POST['freeqty'][$i] : 0;
            $delivery_challan_details['rate'] = (isset($_POST['rate'][$i]) && $_POST['rate'][$i] != '') ? $_POST['rate'][$i] : 0;
            $delivery_challan_details['discount'] = (isset($_POST['discount'][$i]) && $_POST['discount'][$i] != '') ? $_POST['discount'][$i] : 0;
            $delivery_challan_details['amount'] = (isset($_POST['amount'][$i]) && $_POST['amount'][$i] != '') ? $_POST['amount'][$i] : 0;
            $delivery_challan_details['ptr'] = (isset($_POST['ptr'][$i]) && $_POST['ptr'][$i] != '') ? $_POST['ptr'][$i] : 0;
            $delivery_challan_details['gst'] = (isset($_POST['gst'][$i]) && $_POST['gst'][$i] != '') ? $_POST['gst'][$i] : 0;
            $delivery_challan_details['igst'] = (isset($_POST['igst'][$i]) && $_POST['igst'][$i] != '') ? $_POST['igst'][$i] : 0;
            $delivery_challan_details['cgst'] = (isset($_POST['cgst'][$i]) && $_POST['cgst'][$i] != '') ? $_POST['cgst'][$i] : 0;
            $delivery_challan_details['sgst'] = (isset($_POST['sgst'][$i]) && $_POST['sgst'][$i] != '') ? $_POST['sgst'][$i] : 0;
            $delivery_challan_details['totalamount'] = (isset($_POST['totalamount'][$i]) && $_POST['totalamount'][$i] != '') ? $_POST['totalamount'][$i] : 0;
            
            $item = "INSERT INTO delivery_challan_details SET ";
            foreach ($delivery_challan_details as $k => $v) {
                $item .= " ".$k." = '".$v."', ";
            }
        ...
        /*-----------------------------------SAVE DELIVERY CHALLAN ITEMS END----------------------------------------------*/
      }

      if(isset($_GET['id']) && $_GET['id'] != ''){
        $_SESSION['msg']['success'] = "Delivery Challan Updated Successfully.";
      }else{
        //   $id = $challanid ;
        //   $sendmail = send_tax_mail($id);
         $_SESSION['msg']['success'] = "Delivery Challan Added Successfully.";
      }
      
      if(isset($_POST['save'])){
          header('Location: view-delivery-challan.php');exit;
      }elseif(isset($_POST['saveAndNext'])){
          header('Location: delivery-challan.php');exit;
      }elseif(isset($_POST['saveAndPrint'])){
          ?>
          <script>
              window.open("view-delivery-challan.php","_self");
              window.open("print-delivery-challan.php?id=<?php echo $challanid; ?>","_blank");
          </script>
          <?php
          exit;
      ...
      if(isset($_GET['id']) && $_GET['id'] != ''){
        $_SESSION['msg']['fail'] = "Delivery Challan Updated Fail!";
      }else{
        $_SESSION['msg']['fail'] = "Delivery Challan Added Fail!";
      }
    }
  }
?>
<!-------------------------------------------- CODE FOR ADD AND UPDATE DELIVERY CHALLAN END ----------------------------------------------->


<!-------------------------------------------- CODE FOR EDIT ID BY GET ALL DATA START ----------------------------------------------->
<?php 
    if(isset($_GET['id']) && $_GET['id'] != ''){
      $editQ = "SELECT dc.*, lg.name as customer_name,lg.mobile as customer_mobile, lg.email as customer_email, lg.city as customer_city, lg.rate_id  FROM delivery_challan dc LEFT JOIN ledger_master lg ON dc.customer_id = lg.id WHERE dc.id = '".$_GET['id']."' AND dc.pharmacy_id = '".$pharmacy_id."' AND dc.financial_id = '".$financial_id."'";
...
<head>
  ...
  <title>Delivery-Challan - DigiBooks</title>
  <!-- plugins:css -->
                    ...
                    <br>
                      <div class="form-group row">
                        ...
                        <div class="col-12 col-md-2">
                          ...
                          <input type="text" class="form-control" <?php if(isset($_GET['id'])){echo"readonly";} ?> name="invoice_no" id="invoice_no" placeholder="Invoice No" value="<?php echo (isset($editdata['invoice_no'])) ? $editdata['invoice_no'] : getChallanInvoiceNo('Debit'); ?>" required>
                        </div>
                        ...
                        <div class="col-12 col-md-2 customer-name-div">
                          ...
                          <input type="hidden" name="is_general_sale" id="is_general_sale" value="<?php echo (isset($editdata['is_general_sale'])) ? $editdata['is_general_sale'] : 0; ?>">
                            <!--ONLY FOR IHIS START-->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="col-12" style="padding: 0px;">
                      <div class="row">
                        <div class="col-md-12">
                          <a href="view-delivery-challan.php" class="btn btn-light pull-left">Cancel</a>
...
<script src="js/custom/delivery-challan.js"></script>
