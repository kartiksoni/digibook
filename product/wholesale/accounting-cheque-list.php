...
<?php 
    ...
    $listqry = "SELECT accounting_cheque.id, accounting_cheque.voucher_no, accounting_cheque.voucher_type, accounting_cheque.credit_debit, accounting_cheque.cheque_no, accounting_cheque.cheque_date, accounting_cheque.amount, pharmacy_bank_details.bank_name FROM accounting_cheque INNER JOIN pharmacy_bank_details ON accounting_cheque.bank_name = pharmacy_bank_details.id WHERE accounting_cheque.pharmacy_id = '".$p_id."' AND accounting_cheque.financial_id = '".$financial_id."' ORDER BY id DESC";
