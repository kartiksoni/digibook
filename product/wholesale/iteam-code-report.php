                          ...
                          <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                              ...
                              ?>
                                ...
                                <td class="text-right"><?php echo amount_format(number_format($iteam_data['opening_qty'], 2, '.', '')); ?></td>
                                <td class="text-right"><?php echo amount_format(number_format($iteam_data['mrp'], 2, '.', '')); ?></td>
                                <?php 
                                $a[] = $iteam_data['id'];
