	...
	<table align="center" cellpadding="0" cellspacing="0" border="1" width="100%" id="customers" style="line-height:30px;">
		<thead>
          <tr>
            ...
            <th rowspan="2">Voucher/Debit Note Date</th>
            <th  rowspan="2">Voucher/Debit Note No</th>
             <?php } ?>
             <th rowspan="2"><?php if((isset($bill_type) && $bill_type == 'summary') && (isset($type) && $type == 'company_wise')){echo "Company Name"; } else if((isset($bill_type) && $bill_type == 'summary') && (isset($sub_type) && $sub_type == 'all1')){ echo "Product Name"; }else{ echo "Product Name";}?></th>
             <th colspan="2" rowspan="1">Purchase</th>
             <th  colspan="2" rowspan="1">Sale</th>
          </tr>
          <tr>
            <th>Free Qty.</th>
            <th>Amount</th>
          ...
          <?php if(!empty($searchdata)){ ?>
            <?php foreach ($searchdata as $key => $value) { ?>
              <tr>
                ...
                <td><?php echo (isset($value['free_qty1'])) ? $value['free_qty1'] : ''; ?></td>
                <td><?php echo (isset($value['amount1'])) ? $value['amount1'] : ''; ?></td>
              </tr>
              <?php
