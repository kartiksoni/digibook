...
if(isset($_GET['delete']) && $_GET['delete'] != ''){
    $queryD = "DELETE FROM `accounting_cash_management` WHERE id='".$_GET['delete']."'";
    $accountrun = mysqli_query($conn, $queryD);
    if($accountrun){
        $_SESSION['msg']['success'] = 'Data Delete Successfully.';
        header('location:accounting-cash-management-list.php');exit;
    }else{
        $_SESSION['msg']['fail'] = 'Delete fail.';
        header('location:accounting-cash-management-list.php');exit;
    }
}
?>
          ...
          <div class="col-12">
            <div class="table-responsive">
              ...
              <tr>
                    ...
                    <a class="btn  btn-danger p-2" href="accounting-cash-management-list.php?delete=<?php echo $accountdata['id']; ?>" title="Delete" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash-o mr-0"></i></a>
              </tr><!-- End Row -->
              <?php } } ?>
            </tbody>
            </table>
