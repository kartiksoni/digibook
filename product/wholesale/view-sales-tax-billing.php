                                ...
                                <table class="table datatable">
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $qry = "SELECT tb.id, tb.invoice_date, tb.invoice_no, tb.bill_type, tb.customer_name, tb.is_general_sale, tb.final_amount, lgr.name as l_customer_name FROM tax_billing tb LEFT JOIN ledger_master lgr ON tb.customer_id = lgr.id WHERE tb.pharmacy_id = '".$pharmacy_id."' AND tb.financial_id = '".$financial_id."' ORDER BY tb.id DESC";
                                    ...
                                    ?>
                                      <tr>
                                         ...
                                         <?php
                                         $pharmacy ="select print_type from pharmacy_profile where id='".$pharmacy_id."'";
                                         $pharmacyR = mysqli_query($conn, $pharmacy);
                                         $pharmacyL = mysqli_fetch_assoc($pharmacyR);
                                   
                                        if($pharmacyL['print_type'] == 'a4'){ ?>
