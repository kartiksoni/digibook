<?php 
  ...
  if($_POST){
    ...
    if($username != '' && $password != ''){
        $query = " SELECT  * FROM users WHERE username = '".$username."' AND password = '".md5($password)."' AND type='CONSOLE' AND status=1";
            ...
            <div class="auth-form-dark text-left p-5">
              ...
              <form class="pt-5" method="post" action="" autocomplete="off">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="username" id="exampleInputEmail1" placeholder="Username" autocomplete="off">
